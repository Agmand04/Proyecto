         ...
         <nav id="sidebar">
            <div class="sidebar_blog_1">
               <div class="sidebar-header">
                  <div class="logo_section">
                     <a href="Dashboard.php"><img class="logo_icon img-responsive" src="./Asset/img/logo.png"
                           alt="#" /></a>
                  </div>
               </div>
            ...
            <div class="sidebar_blog_2">
               ...
               <ul class="list-unstyled components">
                  ...
                  <li><a href="DashboardListarProducto.php"><i class="fa fa-clock-o orange_color"></i> <span>Productos</span></a></li>
                   <li><a href="#"><i class="fa fa-clock-o orange_color"></i> <span>Clientes</span></a></li>
               
                  <li><a href="#"><i class="fa fa-clock-o orange_color"></i> <span>Empleados</span></a></li>
                  <li><a href="#"><i class="fa fa-clock-o orange_color"></i> <span>Ventas</span></a></li>
               </ul>
            </div>
         </nav>
         <!-- end sidebar -->
