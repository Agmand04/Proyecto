...
<?php include_once "../../includes/encabezado.php" ?>
	<div class="col-xs-12">
		<h1>Eliminar Cliente<?php echo $cliente->Id_Cliente; ?></h1>
		<form method="post" action="../../Controller/Cliente/EliminarClienteController.php">
			...
			<br><br><input class="btn btn-info" type="submit" value="Eliminar">
			<button><a class="btn btn-warning" href="./ListarCliente.php">Regresar al Listado</a></button>
		</form>
	</div>
